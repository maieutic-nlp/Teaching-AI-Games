...
For the final project of this class we will be building an AI to play the popular TV Game show Wheel of Fortune. We will be working off of the [Can I Buy an AI](https://github.com/KentonMurray/CanIBuyanAI) repository. Please FORK this repo and do all of your work in your own GitHub repo. You will be graded based off of your repository.


If you are not familiar with Wheel of Fortune, it's a TV Game Show that has been on the air for decades. For our canonical example in this class, we will use [Pat Sajak's last episode](https://www.youtube.com/watch?v=ldFUR_FDh2M) who hosted the show for more than 4 decades. You should be able to see some of the topics that we are covering in this class such as:
