...
* Chess 10^120 (Shannon number) was published in 1950. Yes, the same Shannon who we talked about for WORDLE last week. {% cite shannon1950xxii %}
* Connect-4. Solved independently 2 weeks apart in 1988 (James Allen 2008; {% cite allis1988knowledge %} ) . In 2008, it was shown to have 4,531,985,219,092 reachable positions  (70,728,639,995,483  had been estimated) {% cite edelkamp2008symbolic %}. The starting player can win.
